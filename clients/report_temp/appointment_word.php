<?
    ...
    header("Content-Disposition: attachment;Filename=Appointment Letter.doc");  
...
<table>
    ...
    <tr>
        ...
        <td>Your annual Cost to the Company would be is Rs. <b><?echo ($atotal+$total_lib)*12;?>.00</b> as per attached annexure.</td>
    </tr>
    <tr>
