    ...
    <div class="page_details">
        <div class="col-sm-12 pad15_line">
            <div class="col-sm-6 pad0">
                <div class="headding">Add Allowance</div>
            </div>  
        </div>
        <div class="col-sm-12 pad15">
            ...
            <?
                if(isset($_POST['submit']))
                {
                    ...
                    $sql="insert into allowance values('','$name','$type','$clientid')";
                    $con->query($sql);
    ...
    <div class="page_details">
        <div class="col-sm-12 pad15_line">
            <div class="col-sm-8 col-xs-12 pad0">
                <div class="headding">Allowance List</div>
            </div>
            <div class="clear"></div>
        </div>
        <div class="col-sm-12 pad15">
            <table id="example" class="table table-striped table-bordered">
                ...
                <tbody>
                    <?
                        $sql="SELECT * FROM allowance where client_id='$clientid' order by(aid) asc";
